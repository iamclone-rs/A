...
if __name__ == "__main__":
    ...
    parser.add_argument("--cjs_margin", type=float, default=0.1, help="margin for conditional jigsaw hinge loss")
    parser.add_argument("--jigsaw_grid", type=int, default=2, help="patch grid size for jigsaw; current implementation supports 2")
